...
The \textbf{AIorNot} detector by Nahrawy on Hugging Face is a pretrained swin-tiny-patch4-window7-224 finetuned on the AI or Not dataset. swin-tiny-patch4-window7-224 by microsoft is a new vision Transformer \cite{https://arxiv.org/pdf/2103.14030.pdf}.
