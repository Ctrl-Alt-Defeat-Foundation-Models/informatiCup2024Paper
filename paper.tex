...
\textbf{Winston AI} is a commercial AI text detector that starts at 18\$ a month. They have two primary methods for checking if a text is AI written. Firstly Linguistic analysis analyses every text of its characteristics like repetitiveness. These characteristics are different between AI and humans. Secondly the other is Data Training, where the detector saw many AI written texts of one model and learned unique characteristics that this model uses which than can be detected.\cite{WinstonAI}
