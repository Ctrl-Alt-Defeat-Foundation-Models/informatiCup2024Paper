...
The \textbf{RoBERTa Base OpenAI Detector} is the output detector model of GPT-2. It was obtained by fine-tune a RoBERTa base model with the ouputs of the GPT-2 model containing 1,5 Billion parameters. RoBERTa Base OpenAI Detector can be used to classify text, on whether it is likely to be created by the GPT-2 model. It was published by OpenAI, when the weights of the GPT-2 model 1,5 Billion parameter version was released.
