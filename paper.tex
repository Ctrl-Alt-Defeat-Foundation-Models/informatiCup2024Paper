...
As a second image generative model we use Dall-E 3 from OpenAI (\url{https://openai.com/dall-e-3}). Dall-E works by modelling text and image tokens as a single data stream. This is achieved by training a transformer to autoregressively model those tokens into the resulting stream.
