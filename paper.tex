...
The resulting pipelines, especially for the images, were very resource intensive and could not be run efficiently on our own machines. We chose to use the free Google Colab resources, consisting of a NVIDIA Tesla T4 GPU that would speed up the pipelines up to 40x compared to our local execution time and allowed to have the same environment for all experiments. 
